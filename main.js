let game = {
  ...
  musicToLoad: ['music'],
  sheetsToLoad: ['startButton','testObstacles','emCee','tiles','mats','weapons','businessman', 'player','exit','shooty', 'hitAnims','weaponExplosion','titleScreen','finalBoss', 'restartButtonGO'],
  imagesToLoad: ['inventoryBackdrop','levelBackdrop', 'titleScreen', 'gameOver', 'winScreen'],
  collisions: null,
  parser: null,
